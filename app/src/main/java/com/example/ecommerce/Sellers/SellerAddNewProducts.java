...
import com.example.ecommerce.Admin.Admin_new_product_Activity;
    ...
    private void store_product_information() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(SellerAddNewProducts.this, "Product Image Upload Successfully", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> uriTask =uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SellerAddNewProducts.this, "Product image Url to database succesafully", Toast.LENGTH_SHORT).show();
    ...
    private void save_product_info_to_data_base() {
        ...
        products_ref.child(product_key).updateChildren(product_map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Intent intent = new Intent(SellerAddNewProducts.this , SellerCatigoryProducts.class);
