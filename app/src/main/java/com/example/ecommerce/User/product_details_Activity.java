...
public class product_details_Activity extends AppCompatActivity {
    ...
    String product_id, product_price2, state = "normal";
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (state.equals("order placed")||state.equals("order shipped")){
                    Toast.makeText(product_details_Activity.this, "You can add more products , once your order is shipped or confirmed.", Toast.LENGTH_SHORT).show();
                }
                else {
                    Adding_to_cart_list();
                }
    ...
    private void Adding_to_cart_list() {
        ...
        cart_hash_map.put("price", product_price2);
        ...
        product_ref.child(product_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    product_price2 = products1.getPrice();
